  ...
  describe("Show JSON", () => {
    ...
    beforeAll(() => {
      const stuntSheet1 = new StuntSheet({
        stuntSheetDots: [new StuntSheetDot({ x: 10 })],
        dotTypes: [
          [
      ...
      const stuntSheet2 = new StuntSheet({
        stuntSheetDots: [new StuntSheetDot({ x: 20 })],
        dotTypes: [
          [
    ...
    it("first stuntsheet is correctly initialized", () => {
      ...
      expect(
        stuntSheet1.stuntSheetDots[0] instanceof StuntSheetDot
      ).toBeTruthy();
    ...
    it("second stuntsheet is correctly initialized", () => {
      ...
      expect(
        stuntSheet2.stuntSheetDots[0] instanceof StuntSheetDot
      ).toBeTruthy();
